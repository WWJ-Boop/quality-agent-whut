...
└─────────────────────────────────────────────────────────┘
    ...
    st.markdown("### 技术栈")
    cols = st.columns(6)
    techs = ["Qwen2.5-7B", "LoRA微调", "多Agent", "Milvus", "Streamlit", "RAG"]
    ...
    st.markdown("---")
    st.markdown("""
    > **说明：** 当前为演示版本，使用基于规则的智能回复。完整版本支持本地大模型推理和RAG知识库检索。
    >
    > **参赛信息：** 第二届武汉理工大学中国研究生智能建造创新大赛 | 赛道：工程大模型 Agent 智能应用系统设计 | 创作者：吴武俊
    """)
